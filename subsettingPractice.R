...
# V 1.1
#
# V 1.1    Update to include code in R-Exercise-BasicSetip
# V 1.0    First code
#
# TODO:
#
...
#TOC> -------------------------------------------------------------
#TOC>   1        REVIEW                                          48
#TOC>   1.1      Sample data                                     51
#TOC>   2        THE SIXFOLD PATH TO SUBSETS                     95
#TOC>   2.1      Subsetting by index                             97
#TOC>   2.2      Using negative indices for subsetting          141
#TOC>   2.3      Subsetting by boolean                          153
#TOC>   2.4      String-matching expressions for subsetting     205
#TOC>   2.5      Subsetting by name                             223
#TOC>   2.6      Using the "$" operator                         256
#TOC>   3        APPLICATION                                    276
#TOC>   3.1      Reading and preprocessing a dataset            278
#TOC>   3.2      Your turn ...                                  336
#TOC>
#TOC> ==========================================================================
...
#     hint: use sample()
LPSdat[sample(1:10, 10, replace = FALSE), 1:2]
# some arguments were uncessary here because of the default behaviour of sample()
#
#
#
#
...
cbind(LPSdat$Mo.LPS[1:10], LPSdat$Mo.ctrl[1:10])
#notice I lose the column names when I use these commands
#
#
#
#
...
LPSdat[(LPSdat$B.ctrl - LPSdat$B.LPS)>2,1]
#
#
#
#
...
# That's it. If you have any intersting ideas about further subsetting and
